...
const simpleNarrativeFields = ["headline", "stageGoalInsight", "scoreInsight", "gapReason", "schoolOpportunity", "nextStep"];
...
function buildSimpleNarrativeFallback(simplePayload: JsonObject) {
  ...
  return {
    ...
    schoolOpportunity: cleanSimpleText(unlockedSchools[0] ? `提分后可新增关注 ${unlockedSchools[0]} 等样本。` : "先确认当前冲稳保层次，再看专业方向。", simpleNarrativeLimits.schoolOpportunity),
